...
describe Station do 
  ...
  it 'should put back a working bike if there is a space' do
    station0.put_back_working(bike1)

    expect(station0.current_bikes).to include bike1
  end

  it 'should not put back a working bike if there is no space' do
    bike2 = double Bike
  ...
  it 'should list all the bike ids at the station' do
    ...
    station0.put_back_working(bike3)
    station0.put_back_working(bike4)
  ...
  it 'should allow a working bike to be hired' do
    station0.put_back_working(bike1)

    expect(station0.hire_a_bike).to eq bike1
  end

  it 'should not allow a bike to be hired if there are no working bikes' do
  ...
  it 'should know if there are any working bikes' do
    station0.put_back_working(bike1)
    
    expect(station0.has_a_working_bike?).to be_true
  end

  it 'should know if there are no working bikes' do
    expect(station0.has_a_working_bike?).to be_false
  end

  it 'should know if there are any broken bikes' do
    station1.put_back_broken(bike1, garage)

    expect(station1.has_a_broken_bike?).to be_true
  end

  it 'should know if there are no broken bikes' do
    expect(station1.has_a_broken_bike?).to be_false
  end

  it 'should allow a broken bike to be collected by a van' do
    station1.put_back_broken(bike1, garage)
